...
description: >-
  Draft a single Conventional Commits 1.0.0 message from git status and git
  diff. Use when the user asks for a commit message, conventional commit text,
  or changelog-ready commit wording. Never run git commit or modify the repo.
trigger: >-
  commit message, conventional commits, git commit message, changelog commit,
  semver commit, draft commit message
---
